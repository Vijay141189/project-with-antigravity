...
module "azurerm_private_endpoint" {
  depends_on        = [module.azurerm_subnet, module.azurerm_storage_account, module.azurerm_key_vault, module.azurerm_resource_group]
  source            = "../../module/azurerm_private_endpoint"
